      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="p-6">
            ...
            <p className="text-2xl font-bold">345.67 INR</p>
          </Card>
          <Card className="p-6">
          ...
          <Card className="p-6">
            ...
            <p className="text-2xl font-bold text-green-500">+45.23 INR</p>
          </Card>
        </div>
      </div>
              ...
              <Card key={position.id} className="p-6">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <p className="font-medium">{position.amount} INR</p>
                    <p
                      className={`text-sm ${
